...
import { evalRecordsForStaff } from '../../lib/selectors';
...
export default function EvalPanel({ targetStaff, staff, roles, evalRecords, onSaveProfile, onCreateRecord, onSaveRecord, onPrint }) {
